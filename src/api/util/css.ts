...
export function addUnit(value: number | string | String = 0, unit: CSSMetricUnits = 'px'): string {
...
export function getCSSValue(value: number | string | String, unit: CSSMetricUnits = 'px'): string {
